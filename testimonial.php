...
<!-- Mirrored from tfhtml.themepul.com/restly/testimonial.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 14:15:17 GMT -->
<head>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8" />
        ...
        <section class="page-banner bgs-cover overlay pt-50" style="background-image: url(assets/images/banner.jpg);">
            <div class="container">
                <div class="banner-inner">
                    <h1 class="page-title">Testimonial One</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Restly</a></li>
                            <li class="breadcrumb-item active">Testimonial One</li>
                        </ol>
                    </nav>
                </div>
            </div>
