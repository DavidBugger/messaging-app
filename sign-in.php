...
<link rel="stylesheet" href="dashboard\assets\libs\sweetalert2\sweetalert2.min.css">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 pe-sm-0">
                                    <div class="p-sm-5 p-3">
                                        ...
                                        <form id="login" action="javascript:void(0)" autocomplete="off">
                                            <input type="hidden" name="type" value="Controller::signIn">
                                            ...
                                            <div class="row gy-3 mt-3">
                                                ...
                                                <div class="col-xl-12 mb-3">
                                                    <label for="signin-password" class="form-label text-default d-block">Password<a href="reset-password-cover.php" class="float-end text-primary">Forget password ?</a></label>
                                                ...
                                                <div class="col-xl-12 d-grid mt-3">
                                                    ...
                                                    <button class="sign-in btn btn-lg btn-primary mt-4 " id="sign_in">Sign In</button>
                                        ...
                                        <div class="text-center ">
                                            <p class="fs-12 text-muted mt-4 mb-0">Dont have an account? <a href="sign-up" class="text-primary" id="login">Sign Up</a></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card custom-card mb-0 cover-background overflow-hidden rounded-end rounded-0">
                                        <div class="card-img-overlay d-flex  align-items-center p-0 rounded-0">
                                            <div class="card-body p-5 rectangle3">
                                                <div>
                                                    <a href="index.html"> <img src="dashboard/assets/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark"></a>
                                                </div>
