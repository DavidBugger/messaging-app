...
<body>
    ...
    <div class="page">
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted"> Copyright © <span id="year"></span> <a href="javascript:void(0);" class="text-dark fw-semibold">Velvet</a>.
...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/avatars.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:47 GMT -->
