...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/reset-password-cover2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:59 GMT -->
                        ...
                        <div class="p-sm-5 p-0">
                            ...
                            <div class="row gy-3 mt-3">
                                ...
                                <div class="col-xl-12 d-grid mt-2">
                                    <a href="index.html" class="btn btn-lg btn-primary">Create</a>
                                    <label class="mt-1">
                                        Remembered your password ?<a href="signin-cover2.php" class="text-primary ms-2 d-inline-block">Login</a>
                                    </label>
                                </div>
                            </div>
                        </div>
