 ...
 * Though not mandatory, you are requested to attribute HCI URL in your code or website.
 * 
 * 
 */
namespace HCI\SecurityService;
...
class securityService
{
    ...
    private $formTokenLabel = 'hci-csrf-token-label';

    private $sessionTokenLabel = 'HCI_CSRF_TOKEN_SESS_IDX';
