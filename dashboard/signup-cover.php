...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/signup-cover.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:59 GMT -->
                                            ...
                                            <div class="p-5">
                                                ...
                                                <div class="row gy-3 mt-3">
                                                    ...
                                                    <div class="col-xl-12 d-grid mt-2">
                                                        <a href="index.html" class="btn btn-lg btn-primary mt-4">Create Account</a>
                                                    </div>
                                                </div>
                                                <div class="text-center">
                                                    <p class="fs-12 text-muted mt-3">Already have an account? <a href="signin-cover.html" class="text-primary">Sign In</a></p>
                                                </div>
                                            ...
                                            <div class="card custom-card mb-0 cover-background overflow-hidden rounded-end rounded-0">
                                                <div class="card-img-overlay d-flex  align-items-center p-0 rounded-0">
                                                    <div class="card-body p-5 rectangle3">
                                                        <div>
                                                            <a href="index.html"> <img src="assets/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark"></a>
                                                        </div>
