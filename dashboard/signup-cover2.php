...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/signup-cover2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:59 GMT -->
                            ...
                            <div class="row gy-3">
                                <div class="row gy-3 mt-3">
                                    ...
                                    <div class="col-xl-12 d-grid mt-4">
                                        <a href="index.html" class="btn btn-lg btn-primary">Create Account</a>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <p class="fs-12 text-muted mt-4">Already have an account? <a href="signin-cover2.php" class="text-primary  d-inline-block">Sign In</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
