...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/signin-basic.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:59 GMT -->
                                ...
                                <div class="card-body p-5 rectangle3">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-12 mb-2">
                                            <label for="signin-password" class="form-label text-default d-block">Password<a href="reset-password-basic.php" class="float-end text-primary">Forget password ?</a></label>
                                    ...
                                    <div class="text-center">
                                        <p class="fs-12 text-muted mt-3">Dont have an account? <a href="signup-basic.php" class="text-primary">Sign Up</a></p>
                                    </div>
