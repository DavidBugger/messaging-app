...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/create-password-cover.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:56 GMT -->
                                            ...
                                            <div class="col-xl-6 col-md-6 pe-0">
                                                <div class="p-5">
                                                    ...
                                                    <div class="text-center">
                                                        <p class="fs-12 text-muted mt-3 mb-0">Back to home ? <a href="index.html" class="text-primary">Click Here</a></p>
                                                    </div>
                                                </div>
                                            </div>
