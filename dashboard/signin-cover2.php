...
<!-- Mirrored from php.spruko.com/velvet/velvet/pages/signin-cover2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 11:39:59 GMT -->
...
<head>
        ...
        <meta name="Description" content="Velvet - PHP Bootstrap5 Responsive Admin & Dashboard Template">
        ...
        <div class="row mx-0 authentication">
                        ...
                        <div class="p-sm-5 p-0">
                            ...
                            <div class="row mx-0 gy-3 mt-3">
                                ...
                                <div class="col-xl-12 mb-3  px-0">
                                    <label for="signin-password" class="form-label text-default d-block">Password<a href="reset-password-cover2.php" class="float-end text-primary">Forget password ?</a></label>
                            ...
                            <div class="text-center">
                                <p class="fs-12 text-muted mt-4">Dont have an account? <a href="signup-cover2.php" class="text-primary  d-inline-block">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-6 col-xl-5 col-lg-5 d-xl-block d-none px-0">
                <div class="authentication-cover">
                    <img src="assets/images/authentication/2.png" class="authentication1" alt="">
                    <img src="assets/images/authentication/3.png" class="authentication2" alt="">
                    <div class="">
