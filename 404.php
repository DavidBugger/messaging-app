...
<!-- Mirrored from tfhtml.themepul.com/restly/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 14:15:17 GMT -->
<head>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8" />
    ...
    <!--====== Title ======-->
    <title>Restly - IT Solutions & Technology HTML Template || 404 Error</title>
    <!--====== Favicon Icon ======-->
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Error Section Start -->
        <section class="error-page text-center py-120 rpy-100">
            <div class="container">
                <div class="error-content">
                    <img src="assets/images/404.png" alt="404 Error">
                    <h2>Oops! page not found.</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                    <a href="index.html" class="theme-btn mt-30">go back</a>
                </div>
            </div>
        </section>
        <!-- Error Section End -->
